...
function Sidebar(){
    return(
        <div className="sidebar">
            ...
            <Link to="/" className="menu"><img src={icon2} alt="Contrate" />Cadastrar testes</Link>
            <Link to="/" className="menu"><img src={icon3} alt="Contrate" />Testes ativos</Link>
            <Link to="/" className="menu"><img src={icon4} alt="Contrate" />Candidatos</Link>
            <Link to="/" className="menu"><img src={icon5} alt="Contrate" />Configurações</Link>
            <Link to="/" className="menu"><img src={icon6} alt="Contrate" />Inscrição</Link>
